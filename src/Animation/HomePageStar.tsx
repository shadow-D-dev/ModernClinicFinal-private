...
export default function HomePageStar() {
  return (
    <motion.div
      ...
      className=" relative bg-white bottom-12  left-12 md:bottom-80 md:-left-32 lg:-left-0 w-64  lg:w-72  p-4 lg:p-6 rounded-3xl  text-black font-plusJakarta xs:hidden flex flex-col gap-2"
    >
